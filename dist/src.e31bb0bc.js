...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"redux/createStore.js":[function(require,module,exports) {
"use strict";
...
},{}],"redux/types.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ADD_INFO = exports.SUBMIT_FORM = exports.REMOVE_RECTANGLE = exports.REMOVE_CIRCLE = exports.ADD_CIRCLE = exports.ADD_RECTANGLE = void 0;
var ADD_RECTANGLE = 'ADD_RECTANGLE';
exports.ADD_RECTANGLE = ADD_RECTANGLE;
var ADD_CIRCLE = 'ADD_CIRCLE';
exports.ADD_CIRCLE = ADD_CIRCLE;
var REMOVE_CIRCLE = 'REMOVE_CIRCLE';
exports.REMOVE_CIRCLE = REMOVE_CIRCLE;
var REMOVE_RECTANGLE = 'REMOVE_RECTANGLE';
exports.REMOVE_RECTANGLE = REMOVE_RECTANGLE;
var SUBMIT_FORM = 'SUBMIT_FORM';
exports.SUBMIT_FORM = SUBMIT_FORM;
var ADD_INFO = 'ADD_INFO';
exports.ADD_INFO = ADD_INFO;
},{}],"figures/createRemoveBtn.js":[function(require,module,exports) {
"use strict";
...
},{}],"figures/circle/renderCircle.js":[function(require,module,exports) {
"use strict";
...
var _createRemoveBtn = require("../createRemoveBtn");
...
function createCircle() {
  ...
  circle.setAttribute('id', "".concat(Date.now()));
  svg.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-arrow-right-square" viewBox="0 0 16 16">\n' + '            <path fill-rule="evenodd" d="M15 2a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2zM0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm4.5 5.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z"/>\n' + '            </svg>' + '<div class="value align-items-center ml-5"></div>';
  storage.append((0, _createRemoveBtn.removeBtn)());
  storage.append(circle);
  storage.append(svg);
  return storage;
}
},{"../createRemoveBtn":"figures/createRemoveBtn.js"}],"figures/rectangle/renderRectangle.js":[function(require,module,exports) {
"use strict";
...
function createRectangle() {
  ...
  var svg = document.createElement('div');
  rect.classList.add('rect', 'm-2');
  storage.classList.add('row', 'm-2');
  svg.classList.add('d-flex', 'align-items-center');
  rect.setAttribute('id', "".concat(Date.now() * 2));
  svg.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-arrow-right-square" viewBox="0 0 16 16">\n' + '            <path fill-rule="evenodd" d="M15 2a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2zM0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm4.5 5.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z"/>\n' + '            </svg>' + '<div class="value align-items-center ml-5"></div>';
  storage.append((0, _createRemoveBtn.removeBtn)());
  storage.append(rect);
  storage.append(svg);
...
},{"../createRemoveBtn":"figures/createRemoveBtn.js"}],"redux/actions.js":[function(require,module,exports) {
"use strict";
...
exports.addRectangle = addRectangle;
exports.removeCircle = removeCircle;
exports.removeRectangle = removeRectangle;
exports.submitForm = submitForm;
exports.addTitle = addTitle;

var _types = require("./types");

var _renderCircle = require("../figures/circle/renderCircle");

var _renderRectangle = require("../figures/rectangle/renderRectangle");

function addCircle() {
  return {
    type: _types.ADD_CIRCLE,
    payload: (0, _renderCircle.createCircle)()
  };
}

function addRectangle() {
  return {
    type: _types.ADD_RECTANGLE,
    payload: (0, _renderRectangle.createRectangle)()
  };
}

function removeCircle(event) {
  return {
    type: _types.REMOVE_CIRCLE,
    payload: event
  };
}
...
function submitForm() {
  return {
    type: _types.SUBMIT_FORM
  };
}

function addTitle(event) {
  return {
    type: _types.ADD_INFO,
    payload: event
  };
}
},{"./types":"redux/types.js","../figures/circle/renderCircle":"figures/circle/renderCircle.js","../figures/rectangle/renderRectangle":"figures/rectangle/renderRectangle.js"}],"figures/rectangle/rectangleEvents.js":[function(require,module,exports) {
"use strict";
...
exports.deleteRectangle = deleteRectangle;

var _actions = require("../../redux/actions");

var addRectBtn = document.getElementById('add-rect');

function rectangleEvents(store) {
  addRectBtn.addEventListener('click', function () {
    store.dispatch((0, _actions.addRectangle)());
  });
}

function deleteRectangle(store, rectArea) {
  rectArea.addEventListener('click', function (event) {
    if (event.target.classList.contains('remove-btn')) {
      store.dispatch((0, _actions.removeRectangle)(event));
    }
  });
}
},{"../../redux/actions":"redux/actions.js"}],"figures/circle/circleEvents.js":[function(require,module,exports) {
"use strict";
...
function circleEvents(store) {
  addCircleBtn.addEventListener('click', function () {
    store.dispatch((0, _actions.addCircle)());
  });
}

function deleteCircle(store, circleArea) {
  circleArea.addEventListener('click', function (event) {
    if (event.target.classList.contains('remove-btn')) {
      store.dispatch((0, _actions.removeCircle)(event));
    }
  });
}
},{"../../redux/actions":"redux/actions.js"}],"../node_modules/@babel/runtime/helpers/esm/defineProperty.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime/helpers/esm/objectSpread2":"../node_modules/@babel/runtime/helpers/esm/objectSpread2.js"}],"figures/removeElement.js":[function(require,module,exports) {
"use strict";
...
var _removeElement = require("../figures/removeElement");
...
function circleReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState.circle;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case _types.ADD_CIRCLE:
      return _objectSpread(_objectSpread({}, state), {}, {
        render: state.element.append(action.payload)
      });

    case _types.REMOVE_CIRCLE:
      return _objectSpread(_objectSpread({}, state), {}, {
        remove: (0, _removeElement.removeElement)(action.payload)
      });
...
function rectangleReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState.rectangle;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case _types.ADD_RECTANGLE:
      return _objectSpread(_objectSpread({}, state), {}, {
        render: state.element.append(action.payload)
      });

    case _types.REMOVE_RECTANGLE:
      return _objectSpread(_objectSpread({}, state), {}, {
        remove: (0, _removeElement.removeElement)(action.payload)
      });
...
},{"./types":"redux/types.js","redux":"../node_modules/redux/es/redux.js","../figures/removeElement":"figures/removeElement.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _createStore = require("./redux/createStore");

var _rectangleEvents = require("./figures/rectangle/rectangleEvents");

var _circleEvents = require("./figures/circle/circleEvents");

var _rootReducer = require("./redux/rootReducer");

var _actions = require("./redux/actions");

var storageArea = document.getElementById('storage');
var circleArea = document.getElementById('circle');
var rectArea = document.getElementById('rectangle');
var circleBtn = document.getElementById('add-circle');
var rectBtn = document.getElementById('add-rect');
var store = (0, _createStore.createStore)(_rootReducer.rootReducer);
(0, _rectangleEvents.rectangleEvents)(store);
(0, _circleEvents.circleEvents)(store);
storageArea.addEventListener('click', function (event) {
  event.preventDefault();

  if (event.target.classList.contains('bi')) {
    store.dispatch((0, _actions.submitForm)());
    store.dispatch((0, _actions.addTitle)(event));
  }
});
(0, _circleEvents.deleteCircle)(store, circleArea);
(0, _rectangleEvents.deleteRectangle)(store, rectArea);
...
},{"./redux/createStore":"redux/createStore.js","./figures/rectangle/rectangleEvents":"figures/rectangle/rectangleEvents.js","./figures/circle/circleEvents":"figures/circle/circleEvents.js","./redux/rootReducer":"redux/rootReducer.js","./redux/actions":"redux/actions.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
